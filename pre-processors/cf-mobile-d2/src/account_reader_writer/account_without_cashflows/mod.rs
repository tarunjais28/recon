...
impl OutputAccount {
    ...
    pub fn get_debit_amt(&self) -> f64 {
        self.debit_amt
    }
    pub fn clear_debit_amt(&mut self) {
        self.debit_amt = 0.;
    }

    // Param is passed by value, moved
    pub fn set_debit_amt(&mut self, v: f64) {
        self.debit_amt = v;
    }

    // double credit_amt = 6;

    pub fn get_credit_amt(&self) -> f64 {
        self.credit_amt
    }
    pub fn clear_credit_amt(&mut self) {
        self.credit_amt = 0.;
    }

    // Param is passed by value, moved
    pub fn set_credit_amt(&mut self, v: f64) {
        self.credit_amt = v;
    }
...
impl ::protobuf::Message for OutputAccount {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.remarks.is_empty() {
            my_size += ::protobuf::rt::string_size(10, &self.remarks);
        }
        if !self.branch.is_empty() {
            my_size += ::protobuf::rt::string_size(11, &self.branch);
        }
    ...
    fn write_to_with_cached_sizes(
        ...
        if self.debit_amt != 0. {
            os.write_double(5, self.debit_amt)?;
        }
        if self.credit_amt != 0. {
            os.write_double(6, self.credit_amt)?;
        }
        if self.amount != 0. {
        ...
        if self.balance != 0. {
            os.write_double(9, self.balance)?;
        }
        if !self.remarks.is_empty() {
            os.write_string(10, &self.remarks)?;
        }
        if !self.branch.is_empty() {
            os.write_string(11, &self.branch)?;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                >(
                    "debit_amt",
                    |m: &OutputAccount| &m.debit_amt,
                    |m: &mut OutputAccount| &mut m.debit_amt,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeDouble,
                >(
                    "credit_amt",
                    |m: &OutputAccount| &m.credit_amt,
                    |m: &mut OutputAccount| &mut m.credit_amt,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeDouble,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0ematurity.proto\"\xae\x02\n\rOutputAccount\x12\x17\n\x07gl_date\x18\
    \x01\x20\x01(\x03R\x06glDate\x12\x17\n\x07tran_id\x18\x02\x20\x01(\tR\
    \x06tranId\x12\x17\n\x07ref_num\x18\x03\x20\x01(\tR\x06refNum\x12\x20\n\
    \x0bparticulars\x18\x04\x20\x01(\tR\x0bparticulars\x12\x1b\n\tdebit_amt\
    \x18\x05\x20\x01(\x01R\x08debitAmt\x12\x1d\n\ncredit_amt\x18\x06\x20\x01\
    (\x01R\tcreditAmt\x12\x16\n\x06amount\x18\x07\x20\x01(\x01R\x06amount\
    \x12\x10\n\x03ccy\x18\x08\x20\x01(\tR\x03ccy\x12\x18\n\x07balance\x18\t\
    \x20\x01(\x01R\x07balance\x12\x18\n\x07remarks\x18\n\x20\x01(\tR\x07rema\
    rks\x12\x16\n\x06branch\x18\x0b\x20\x01(\tR\x06branchb\x06proto3\
";
